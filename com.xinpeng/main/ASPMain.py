...
file_name_all = os.listdir(
    'W:/Finance Volvo/Confidential/Albert/6 QLIKVIEW/QlikView_sources_restricted/ASP/ASP Testing/Raw data/')
file_name = []
    ...
    if not header_result:
        ...
        for idx_row in range(len(df_fcst[header_std[0]])):
            if to_split_fcstact(idx_row, file_name[file_idx]):
                ...
                if is_null(idx_row) and calc_total_budget(idx_row) and is_duplicate(file_name[file_idx],
