        ...
        for idx_row in range(len(df_fcst[header_std[0]])):
            ...
            if str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() == 'MKT':
                for idx_col in range(len(header_std)):
                    ...
                    row_data_MKT.append(df_fcst[header_std[idx_col]][idx_row])
                data_MKT.append(row_data_MKT)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() == 'MKTLAUNCH':
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_MKT_Launch.append(df_fcst[header_std[idx_col]][idx_row])
                data_MKT_Launch.append(row_data_MKT_Launch)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() == 'APACCC':
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_APAC_CC.append(df_fcst[header_std[idx_col]][idx_row])
                data_APAC_CC.append(row_data_APAC_CC)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() == 'CUSTOMERSERVICE':
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_Customer_Service.append(df_fcst[header_std[idx_col]][idx_row])
                data_Customer_Service.append(row_data_Customer_Service)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() == 'DTS':
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_DTS.append(df_fcst[header_std[idx_col]][idx_row])
                data_DTS.append(row_data_DTS)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() == 'MI':
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                ...
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_Sales_MKT1.append(df_fcst[header_std[idx_col]][idx_row])
                data_Sales_MKT1.append(row_data_Sales_MKT1)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() in ['SALESMKT'] and str(
                    df_fcst[header_std[2]][idx_row]).replace(' ', '').upper() in ['HK']:
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_Sales_MKT2.append(df_fcst[header_std[idx_col]][idx_row])
                data_Sales_MKT2.append(row_data_Sales_MKT2)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() in ['SALESMKT'] and str(
                    df_fcst[header_std[2]][idx_row]).replace(' ', '').upper() in ['INTERNALFLEETCAR']:
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_Sales_MKT3.append(df_fcst[header_std[idx_col]][idx_row])
                data_Sales_MKT3.append(row_data_Sales_MKT3)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() in ['SALESMKT'] and str(
                    df_fcst[header_std[2]][idx_row]).replace(' ', '').upper() in ['NATIONALSALES']:
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_Sales_MKT4.append(df_fcst[header_std[idx_col]][idx_row])
                data_Sales_MKT4.append(row_data_Sales_MKT4)
            elif str(df_fcst[header_std[1]][idx_row]).replace(' ', '').upper() in ['SALESMKT'] and str(
                    df_fcst[header_std[2]][idx_row]).replace(' ', '').upper() in ['NBDTEAM']:
                for idx_col in range(len(header_std)):
                    to_float(df_fcst, header_std, idx_col, idx_row)
                    row_data_Sales_MKT5.append(df_fcst[header_std[idx_col]][idx_row])
