...
file_name = ["D:/ASP - Erin/Raw Data/ASP Dbase Report 2019 FCST 1+11.xlsx","D:/ASP - Erin/Raw Data/ASP Dbase Report 2019 FCST 1+11.xlsx"]

data_new = []
data_err = []
file_new = "D:/ASP - Erin/Raw Data/summary.xlsx"
...
for file_idx in range(len(file_name)):
    ...
    if not header_result.all():
        row_data_err = [file_name[file_idx], 'Header Exception', 'All']
