...
for idx_row in range(len(df_summary[header_std[0]])):
    ...
    elif str(df_summary[header_std[1]][idx_row]) in ['Sales MKT', 'Sales_MKT'] and str(df_summary[header_std[2]][idx_row]) in [
    ...
    elif str(df_summary[header_std[1]][idx_row]) in ['Sales MKT', 'Sales_MKT'] and str(df_summary[header_std[2]][idx_row]) in ['HK']:
        for idx_col in range(len(header_std)):
            to_float2(idx_col, idx_row)
